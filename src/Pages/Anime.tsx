...
import CollapsedText from '../components/posts/collapsedText';
...
export default function Anime() {
	...
	const seasonDate =
		data.anime.status === 'UNRELEASED'
			? data.anime.tba
			: capitalizeFirstLetter(data.anime.season?.toLowerCase()) +
			  data.anime.startDate;
					...
					<div className='v-split'>
						<div className='poster-and-edit'>
							<img
								...
								src={data.anime.posterImage.original.url}
								alt='poster img'
							/>
							<Dropdown
								className='watching-status'
								options={[
									'Currently Watching',
									'On Hold',
									'Completed',
						...
						<div className='media-details'>
							<span className='jp-title'>
								{data.anime.titles.localized['ja_jp']}
							</span>
