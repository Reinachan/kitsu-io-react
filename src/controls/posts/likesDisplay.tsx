...
import '../../scss/Posts/postLikes.scss';
import { AvatarSmall, NoAvatar } from '../avatar';
					...
					<div className="like-heads">
						{
							data.nodes?.slice(0, displayed).map(profile => {
								if (profile?.avatarImage) {
									return <AvatarSmall srcSet={
										profile.avatarImage.views[3].url +" x4," +
										profile.avatarImage.views[2].url +" x3," +
										profile.avatarImage.views[1].url +" x2,"
									}
									src={profile.avatarImage.views[0].url}
									alt="like head"/>;
								}
