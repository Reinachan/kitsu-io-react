...
export type Mutation = {
  ...
  readonly anime?: Maybe<AnimeMutations>;
  readonly episode?: Maybe<EpisodeMutations>;
  readonly libraryEntry?: Maybe<LibraryEntryMutations>;
  readonly mapping?: Maybe<MappingMutations>;
  readonly post?: Maybe<PostMutations>;
...
export type GetProfileBySlugQueryVariables = Exact<{
  ...
  postCursor?: Maybe<Scalars['String']>;
  postFirst: Scalars['Int'];
}>;


export type GetProfileBySlugQuery = (
  { readonly __typename?: 'Query' }
  & { readonly findProfileById?: Maybe<(
    { readonly __typename?: 'Profile' }
    & GetProfileFragment
  )>, readonly findProfileBySlug?: Maybe<(
    { readonly __typename?: 'Profile' }
    & GetProfileFragment
  )> }
);

export type GetProfileFragment = (
  { readonly __typename?: 'Profile' }
  & Pick<Profile, 'about'>
  & { readonly posts: (
    { readonly __typename?: 'PostConnection' }
...
export const CommentFragmentDoc = gql`
  ...
  likes(first: 10) {
    ...
    ${UserFragmentDoc}`;
export const GetProfileFragmentDoc = gql`
...
export const GetProfileBySlugDocument = gql`
    query getProfileBySlug($id: ID!, $slug: String!, $isId: Boolean!, $postCursor: String, $postFirst: Int!) {
 ...
 *      slug: // value for 'slug'
 *      isId: // value for 'isId'
 *      postCursor: // value for 'postCursor'
 *      postFirst: // value for 'postFirst'
 *   },
 * });
 */
